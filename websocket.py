...
with open(r"C:\Users\apro\OneDrive\Desktop\AIRISS\airiss_v4\app\api\websocket.py", "w", encoding="utf-8") as f:
    f.write(content)
    
print("websocket.py created successfully!")
@echo off
echo ==========================================
echo AIRISS Complete Setup and Deploy
echo ==========================================

cd /d C:\Users\apro\OneDrive\Desktop\AIRISS\airiss_v4

echo Step 1: Check EB applications...
eb list

echo Step 2: Create environment if needed...
eb status >nul 2>&1 || (
...
echo ==========================================
echo Complete! Your AIRISS is now live on AWS
echo ==========================================
pause
